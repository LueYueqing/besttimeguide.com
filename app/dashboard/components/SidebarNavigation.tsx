          ...
          <div className="mt-6 pt-6 border-t border-neutral-200">
            {(() => {
              ...
              if (hasProTrial && proTrialDaysLeft > 0) {
                return (
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <div className="text-sm font-semibold text-blue-900 mb-2">Pro 试用中</div>
                    <p className="text-xs text-blue-700 mb-2">
                      剩余 {proTrialDaysLeft} {proTrialDaysLeft === 1 ? '天' : '天'}
                    </p>
                  </div>
                )
              }
              ...
              if (planLabel === 'Free' && !subscription) {
                return (
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <div className="text-sm font-semibold text-blue-900 mb-2">当前计划: Free</div>
              ...
              return (
                <div className="p-4 bg-neutral-50 rounded-lg border border-neutral-200">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="text-sm font-semibold text-neutral-900">当前计划: {planLabel}</div>
                  ...
                  {subscription?.expiresAt && (
                    <p className="text-xs text-neutral-600 mb-2">
                      {subscription.cancelAtPeriodEnd
                        ...
                        : `续费时间: ${formatDate(subscription.expiresAt)}`}
                    </p>
                  )}
                  <Link
                    href="/dashboard/profile"
