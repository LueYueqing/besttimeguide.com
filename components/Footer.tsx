      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 mb-6 text-white/90 text-sm">
            ...
            <Link href="/category/travel" className="hover:text-white transition-colors">Travel</Link>
            <Link href="/category/social-media" className="hover:text-white transition-colors">Social Media</Link>
            <Link href="/category/health" className="hover:text-white transition-colors">Health</Link>
