...
export const metadata: Metadata = {
  title: 'API Documentation - QR Code Generator API | CustomQR.pro',
  description: 'Complete RESTful API documentation for CustomQR.pro. Generate QR codes programmatically, integrate batch generation, and access advanced features. Full API reference with examples.',
  keywords: 'QR code API, QR generator API, RESTful API, QR code integration, API documentation, bulk QR generation API',
  alternates: {
    canonical: 'https://customqr.pro/api-docs',
  },
}
      ...
      <section className="hero hero-bg">
        <div className="hero-container text-center">
          ...
          <p className="hero-subtitle fade-in-up">
            Integrate CustomQR.pro into your applications with our powerful RESTful API. 
            Generate QR codes programmatically, access analytics, and automate workflows.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a href="/contact" className="btn btn-ghost text-neutral-700 border-neutral-300 hover:bg-neutral-100 btn-lg">
                <span>📞</span>
                Contact Sales
              </a>
            </div>
