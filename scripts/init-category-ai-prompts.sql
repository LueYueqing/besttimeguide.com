-- 初始化分类 AI 提示词
-- 为各个分类设置专门的 AI 文章生成提示词模板
-- 支持变量：{title}, {categoryName}, {sourceContent}
...
-- 2. Social Media 分类
UPDATE "categories" 
SET "aiPrompt" = 'You are a social media strategist and digital marketing expert.
...
-- 3. Health 分类
UPDATE "categories" 
SET "aiPrompt" = 'You are a certified health writer and wellness expert with a background in nutrition and fitness.
...
-- 4. Shopping 分类
UPDATE "categories" 
SET "aiPrompt" = 'You are a shopping expert and consumer advocate.
...
-- 5. Lifestyle 分类
UPDATE "categories" 
SET "aiPrompt" = 'You are a lifestyle writer and cultural commentator.
