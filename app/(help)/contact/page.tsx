            ...
            <div className="space-y-8">
              ...
              <div className="card p-6">
                ...
                <div className="space-y-3">
                  <a href="/faq" className="flex items-center gap-3 text-neutral-700 hover:text-primary-600 transition-colors">
                    <span>❓</span>
                    <span>Frequently Asked Questions</span>
                  </a>
                  <a href="/api-docs" className="flex items-center gap-3 text-neutral-700 hover:text-primary-600 transition-colors">
                    <span>📚</span>
